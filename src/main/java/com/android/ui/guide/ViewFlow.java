...
public class ViewFlow extends AdapterView<Adapter> {
	...
	/**
	   ...
	   * 
	   * @param adapter
	   * @param initialPosition 初始化当前选中的位置
	 */
	...
	private void postViewSwitched(int direction) {
		...
		Log.i("xes", "mCurrentAdapterIndex: " + mCurrentAdapterIndex);
		logBuffer();
	}
	...
	private void logBuffer() {
		...
		Log.d("viewflow",
				"Size of mLoadedViews: " + mLoadedViews.size() + ", Size of mRecycledViews: " + mRecycledViews.size() + ", X: "
