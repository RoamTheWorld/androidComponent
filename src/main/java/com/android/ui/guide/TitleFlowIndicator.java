...
public class TitleFlowIndicator extends TextView implements FlowIndicator {
	...
	public TitleFlowIndicator(Context context, AttributeSet attrs) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ViewFlow_TitleFlowIndicator);

		String customTypeface = a.getString(R.styleable.ViewFlow_TitleFlowIndicator_customTypeface);
		// Retrieve the colors to be used for this view and apply them.
		int footerColor = a.getColor(R.styleable.ViewFlow_TitleFlowIndicator_vf_footerColor, FOOTER_COLOR);
		footerLineHeight = a.getDimension(R.styleable.ViewFlow_TitleFlowIndicator_vf_footerLineHeight, FOOTER_LINE_HEIGHT);
		footerTriangleHeight = a.getDimension(R.styleable.ViewFlow_TitleFlowIndicator_footerTriangleHeight, FOOTER_TRIANGLE_HEIGHT);
		int selectedColor = a.getColor(R.styleable.ViewFlow_TitleFlowIndicator_selectedColor, SELECTED_COLOR);
		boolean selectedBold = a.getBoolean(R.styleable.ViewFlow_TitleFlowIndicator_vf_selectedBold, SELECTED_BOLD);
		int textColor = a.getColor(R.styleable.ViewFlow_TitleFlowIndicator_textColors, TEXT_COLOR);
		float textSize = a.getDimension(R.styleable.ViewFlow_TitleFlowIndicator_textSizes, TEXT_SIZE);
		float selectedSize = a.getDimension(R.styleable.ViewFlow_TitleFlowIndicator_selectedSize, textSize);
		titlePadding = a.getDimension(R.styleable.ViewFlow_TitleFlowIndicator_vf_titlePadding, TITLE_PADDING);
		clipPadding = a.getDimension(R.styleable.ViewFlow_TitleFlowIndicator_vf_clipPadding, CLIP_PADDING);
	 ...
	 */
	private void initDraw(int textColor, float textSize, int selectedColor, boolean selectedBold, float selectedSize, float footerLineHeight,
			int footerColor) {
		paintText = new Paint();
