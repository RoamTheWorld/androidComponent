 ...
 *
 */
public class PullSeparateListView extends Up72ListView{
	/**
	 * 最大滑动距离
	 */
	...
	public PullSeparateListView(Context context, AttributeSet attrs) {
		...
		separateAll = t.getBoolean(R.styleable.PullSeparateListView_separate_all, true);
		showDownAnim = t.getBoolean(R.styleable.PullSeparateListView_showDownAnim, false);
		t.recycle();
		init();
	}
