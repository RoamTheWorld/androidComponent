...
public interface IZoomView {
	...
	void setOnMatrixChangeListener(
			ZoomViewAttacher.OnMatrixChangedListener listener);
	 ...
	 *            - Listener to be registered.
	 */
	void setOnPhotoTapListener(ZoomViewAttacher.OnPhotoTapListener listener);
	 ...
	 *            - Listener to be registered.
	 */
	void setOnViewTapListener(ZoomViewAttacher.OnViewTapListener listener);
